...
After completing windows setup then run windows command line (cmd)
  cd daemon
  pingasd
You would need to create a configuration file pingas.conf in the default
wallet directory. Grant access to pingasd.exe in anti-virus and firewall
...
pingasd backupwallet <destination_backup_file>
Then shutdown ppcoind by
pingasd stop
Start up the new pingasd (0.3.0).
