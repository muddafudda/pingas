...
static const uint256 hashGenesisBlockOfficial("0x000004275821926ce97a155d78893a780a4cc1fc719697491ee3bf76e9c10d23");
...
// pingas: calculate Nfactor using timestamp
...
public:
    ...
    {
        // Protocol switch to support p2pool at pingas block #9689
//        if (nHeight >= 9689)
        {
...
/*        // Before pingas block #9689 - old protocol
