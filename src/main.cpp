...
unsigned int nStakeTargetSpacing = 180; //  16 second minute block spacing
int64 nChainStartTime = 1388157521;
...
const string strMessageMagic = "Pingas Signed Message:\n";
...
// pingas: increasing Nfactor gradually
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Pingas", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Pingas are born-ed.";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xc839bd80a5748eb6169254a6b6a3975af88be543784f370ffde643159656aaee"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf9, 0xf6, 0xd7, 0xe6 };
